...
def naturalize_generation_text(value: Any, field: str = "", client_name: str = "") -> str:
    ...
    if field_key == "klasifikasi_kebutuhan":
        ...
        if selected:
            if len(selected) == 3:
                return "kebutuhan prioritas yang perlu dipetakan dari situasi, risiko, dan manfaat keputusan"
            labels = {
                "problem": "masalah yang perlu ditangani",
                "opportunity": "manfaat keputusan yang perlu dibuktikan",
                "directive": "mandat kerja yang perlu diterjemahkan menjadi kontrol pelaksanaan",
            }
