...
_REPLACEMENTS = (
    ...
    (r"\bProblem\s*-\s*Solution\s*-\s*Action\b", "alur masalah, solusi, dan aksi"),
    (r"\bProblem\b", "kebutuhan utama"),
    (r"\bOpportunity\b", "peluang penguatan"),
    (r"\bDirective\b", "arahan prioritas"),
    (r"(?-i:\bPSA\b)", "alur konsultatif"),
    (r"(?-i:\bPAS\b)", "alur konsultatif"),
...
_LANGUAGE_REPLACEMENTS = (
    ...
    (r"\bon\s*-\s*scope\b", "sesuai ruang lingkup"),
