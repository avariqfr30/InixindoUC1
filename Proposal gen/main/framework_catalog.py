...
class FrameworkCatalogService:
            ...
            "options": [
                {
                    ...
                    "use_cases": item.get("use_cases") if isinstance(item.get("use_cases"), list) else self._parse_list_value(item.get("use_cases")),
    ...
    def _normalize_version_item(self, raw: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "use_cases": self._parse_list_value(raw.get("use_cases") or raw.get("child_use_cases")),
        ...
        for raw in raw_options:
            ...
            if entry is None:
                entry = {
                    ...
                    "use_cases": self._parse_list_value(raw.get("use_cases") or raw.get("parent_use_cases")),
                    "versions": [],
                ...
                if not entry.get("use_cases"):
                    entry["use_cases"] = self._parse_list_value(raw.get("use_cases") or raw.get("parent_use_cases"))
