...
# Replace from the first "class FirmAPIClient:" up to the last "def _extract_first(pattern: str, text: str) -> str:"
pattern = re.compile(r"class FirmAPIClient:.*?    @staticmethod\n    def _extract_first\(pattern: str, text: str\) -> str:", re.DOTALL)

new_class = """class FirmAPIClient:
...
if pattern.search(text):
    new_text = pattern.sub(new_class, text)
