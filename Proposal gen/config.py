...
UNIVERSAL_STRUCTURE = [
    {
        ...
        "length_intent": "Jelaskan latar belakang organisasi klien yang menjadi dasar kebutuhan konsultasi, termasuk kondisi internal-eksternal yang relevan. (Target: 900 words)."
    },
    {
        ...
        "length_intent": "Tangkap dengan jelas apa yang benar-benar dibutuhkan atau diinginkan klien serta konteks masalah inti yang harus diselesaikan. (Target: 1000 words)."
    },
    {
        ...
        "length_intent": "Klasifikasikan kebutuhan klien ke dalam problem/opportunity/directive lalu tetapkan tujuan proyek dan jenis proyek yang paling tepat. (Target: 900 words)."
    },
    {
        ...
        "length_intent": "Uraikan acuan dan prinsip yang digunakan (framework/teori/regulasi/standar) sebagai landasan menyelesaikan masalah klien. (Target: 900 words)."
    },
    {
        ...
        "length_intent": "Jelaskan mengapa metodologi tersebut dipilih dan bagaimana langkah kerja detail menggunakan framework tersebut. (Target: 1100 words).",
    ...
    },
    {
        ...
        "length_intent": "Jelaskan desain solusi (output metodologi) yang akan dibangun atau diterapkan agar kebutuhan klien dapat tercapai. (Target: 1100 words)."
    },
    {
        ...
        "length_intent": "Jelaskan aktivitas yang dilakukan, kapan dilakukan, pada fase apa, serta deliverable pada setiap fase pekerjaan. (Target: 900 words).",
        "visual_intent": "gantt"
    },
    {
        ...
        "length_intent": "Jelaskan tata kelola proyek, termasuk mekanisme pengambilan keputusan dan pengendalian agar proyek berjalan efektif. (Target: 900 words)."
    },
    {
        ...
        "length_intent": "Tunjukkan struktur dan komposisi tim proyek beserta kapabilitas, pengalaman, dan sertifikasi untuk membangun kepercayaan klien. (Target: 900 words)."
    },
    {
        ...
        "length_intent": "Jelaskan model bisnis proyek yang mencakup biaya, tahapan pembayaran, model pekerjaan, dan batasan pekerjaan secara jelas dan tegas. (Target: 900 words)."
    }
]
...
2. FORMATTING (MANDATORY):
   ...
   - Under each H2, create at least 3 H3 subsections (###).
   - Use numbered lists for steps/sequences (1., 2., 3.) and bullet lists for detail points (-).
   - Include at least 1 markdown table in chapters with operational, governance, timeline, or commercial content.
...
- Ensure the chapter is sufficiently detailed for board-level review and contributes to total proposal length target 20-25 pages.
